'''opencv_traincascade -data ../haarcascade -vec positives.vec -bg negatives.txt -numPos 5000 -numNeg 10000 -numStages 10 -w 30 -h 30 -featureType HAAR -precalcValBufSize 2048 -precalcIdxBufSize 2048 -bt RAB -numThreads 4'''
...
CREATE_SAMPLES_COMMAND_EX = "opencv_createsamples -img POS_IMG -bg " + GEN_NEG_FILE + " -info INFO_LOC -pngoutput SAMPLES_PATH -maxxangle 0.2 -maxyangle 0.2 -maxzangle 0.2 -num NUM_IMG"
...
TRAIN_CASCADE_COMMAND = "opencv_traincascade -data ../" + DATA_FOLDER + " -vec " + VEC_FILE + " -bg " + NEG_FILE + " -numPos POS_IMGS -numNeg NEG_IMGS -numStages " + DEFAULT_STAGES + " -w " + WIDTH + " -h " + HEIGHT + " -featureType HAAR -precalcValBufSize 2048 -precalcIdxBufSize 2048 -bt RAB -numThreads 4"
