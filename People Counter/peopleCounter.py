...
while True:
    ...
    contours, hierarcky = cv2.findContours(
    ...
    # Linhas do offset
    cv2.line(
        frame, (xy1[0], posL-offset), (xy2[0], posL-offset),
        (255, 255, 0), 2)
    cv2.line(
        frame, (xy1[0], posL+offset), (xy2[0], posL+offset),
        (255, 255, 0), 2)
    ...
    i = 0  # id das pessoas
    for cnt in contours:
        # Quatro variavies para fazer o rect
        ...
        if int(area) > 3000:
            ...
            cv2.putText(
                frame, str(i), (x+5, y+15), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
                (0, 255, 255), 2)
