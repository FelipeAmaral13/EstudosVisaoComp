...
for fn in range(len(pdfs_files)):
  ...
  try:
      ...
      images = convert_from_path(pdfs_files[fn], poppler_path=r'C:\Program Files (x86)\poppler-0.68.0\bin')
  ...
  try:
      ...
      HORAS.append(re.search(r"completed (.*[0-9]) total", INFO_LIMPO).group(1))
  except AttributeError:
      print('Nao rolou')
