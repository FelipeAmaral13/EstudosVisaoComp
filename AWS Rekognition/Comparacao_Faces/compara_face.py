...
# Haarcascade
faceCascade = cv2.CascadeClassifier(path + r'\Haarcascades\haarcascade_frontalface_default.xml')
...
while True:
    ...
    if k == 27: # press 'ESC' para quitar e salvar a imagem
        cv2.imwrite(path + r'\face_detect.png', roi_color)
        break
