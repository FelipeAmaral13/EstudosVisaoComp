...
for kp in keypts:
    ...
    coin += 1
    cv2.rectangle(img_dolar_coin,(int(kp.pt[0]),int(kp.pt[1])),(int(kp.pt[0])+1,int(kp.pt[1])+1),(255,0,0), 8)
    cv2.circle(img_dolar_coin, (int(kp.pt[0]), int(kp.pt[1])), int(kp.size/2), (0, 255, 0), 2)
