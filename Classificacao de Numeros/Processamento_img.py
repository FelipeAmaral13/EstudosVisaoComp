...
titles = ['Imagem Original','Tons de Cinza','Filtro Blur','Deteccao de Bordas','Dilatacao','Segmentacao']
...
for c in cnts:
    ...
    if area > 1100 :
        ...
        ROI = cv2.resize(ROI, (28,28), interpolation = cv2.INTER_AREA) # Salvar a imagem 28x28 (Modelo treinado MNIST)
